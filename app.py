...
st.markdown("---")
st.markdown("""
<div style="display:flex;justify-content:center;gap:3rem;padding:1.5rem 0 2rem 0;">
    <div style="text-align:center">
        <div style="font-size:2.5rem;font-weight:700;color:#60a5fa">{total}</div>
        <div style="font-size:0.8rem;color:#64748b;margin-top:0.2rem">Total Scans</div>
    </div>
    <div style="text-align:center">
        <div style="font-size:2.5rem;font-weight:700;color:#10b981">{trusty}</div>
        <div style="font-size:0.8rem;color:#64748b;margin-top:0.2rem">Trustworthy</div>
    </div>
    <div style="text-align:center">
        <div style="font-size:2.5rem;font-weight:700;color:#ef4444">{mislead}</div>
        <div style="font-size:0.8rem;color:#64748b;margin-top:0.2rem">Misleading</div>
    </div>
</div>
""".format(total=total, trusty=trusty, mislead=mislead), unsafe_allow_html=True)
